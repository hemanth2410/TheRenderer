...
void Graphics::DrawTestTriangle(float angle, float x, float y)
{
	...
	Vertex vertices[] = {
		{ 0.0f,0.5f,255,0,0,128 },
		{ 0.5f,-0.5f,0,255,0,128 },
		{ -0.5f,-0.5f,0,0,255,128 },
		{ -0.3f,0.3f,0,0,255,128 },
		{ 0.3f,0.3f,0,255,0,128 },
		{ 0.0f,-0.8f,255,0,0,128 },
	};
...
{
	return "GPU Fucked Exception [Device Removed] (DXGI_ERROR_DEVICE_REMOVED)";
}
