...
namespace Bind
{
	...
	public:
		...
		virtual void Unbind(Graphics& gfx) noxnd {} // NEW: default no-op
		void Clear(Graphics& gfx) noxnd override;
		Surface ToSurface(Graphics& gfx, bool linearlize) const;
	...
	public:
		...
		void Unbind(Graphics& gfx) noxnd override; // NEW
	private:
		UINT slot;
